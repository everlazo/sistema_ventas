...
@section('content')
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <img src="@if ($tercero->imagen == null or $tercero->imagen == '') {{ asset('plantilla/images/app/user.jpg') }} @else {{ asset('imagenes/tercero/' . $tercero->imagen) }} @endif"
                                            id="img_imagen" alt="image" class="img-thumbnail" width="100%"
                                            height="200">
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="imagen"
                                                id="nombre_archivo">Examinar</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_dominio_tipo_identificacion" class="form-control" required>
                                                    @foreach ($tipos_identificacion as $tipo)
                                                        <option @if ($tercero->id_dominio_tipo_identificacion == $tipo->id_dominio) selected @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"><b>Correo
                                                        electrónico</b></label>
                                                <input name="email" type="email" class="form-control"
                                                    aria-required="true" aria-invalid="false" value="{{ $tercero->email }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="id_dominio_sexo" class="form-control" required>
                                                    @foreach ($tipos_sexo as $tipo_sexo)
                                                        <option @if ($tercero->id_dominio_sexo == $tipo_sexo->id_dominio) selected @endif
                                                            value="{{ $tipo_sexo->id_dominio }}">{{ $tipo_sexo->nombre }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"><b>*Tipo
                                                        tercero</b></label>
                                                @php
                                                ...
                                                <select name="id_dominio_tipo_tercero" class="form-control" required>
                                                    ...
                                                    @foreach ($tipos_tercero as $tipo)
                                                        <option @if ($tercero->id_dominio_tipo_tercero == $tipo->id_dominio) selected @endif
                                                            @if ($tercero->id_dominio_tipo_tercero == null and $tipo->id_dominio == 3) selected @endif
                                                            value="{{ $tipo->id_dominio }}">{{ $tipo->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="estado" class="form-control" required>
                                                    <option @if ($tercero->estado == 0) selected @endif
                                                        value="0">Inactivo</option>
                                                    <option @if ($tercero->estado == 1 || $tercero->id_tercero == null) selected @endif
                                                        value="1">
                                                        Activo
                                                    </option>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cc-payment"
                                                    class="control-label mb-1"><b>Dirección</b></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cc-payment"
                                                    class="control-label mb-1"><b>*Departamento</b></label>
                                                @php
                                                    $departamentos = \App\Dominio::all()->where('id_padre', 59);
                                                @endphp
                                                <select name="id_departamento" id="select-departamento"
                                                    class="form-control" required>
                                                    <option value="">Seleccione un departamento</option>
                                                    @foreach ($departamentos as $tipo)
                                                        <option @if ($tercero->id_departamento == $tipo->id_dominio) selected @endif
                                                            value="{{ $tipo->id_dominio }}">{{ $tipo->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"><b>*Ciudad</b></label>
                                                <select name="id_ciudad" id="select-ciudad" class="form-control"
                                                    required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="clasificacion">
                                                    ...
                                                    <option @if ($tercero->clasificacion == 'MINORISTA') selected @endif
                                                        value="MINORISTA">Minorista</option>
                                                    <option @if ($tercero->clasificacion == 'MAYORISTA') selected @endif
                                                        value="MAYORISTA">Mayorista</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <center>
                                            <button class="btn btn-primary"
                                                style="background-color: #35b12e; border-color: #35b12e"><i
    ...
    <script src="/plantilla/municipio.js"></script>
@endsection
