                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <center>
                                            <img src="@if ($tercero->imagen == null or $tercero->imagen == '') {{ asset('plantilla/images/app/user.jpg') }} @else {{ asset('imagenes/tercero/' . $tercero->imagen) }} @endif"
                                                id="img_imagen" alt="image" class="rounded-circle" width="200"
                                                height="200">
                                            <br>
                                            <strong
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"><b>Clasificación:
                                                    </b>{{ $tercero->clasificacion }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card text-white bg-flat-color-3">
                                        <div class="card-body">
                                            <div class="card-left pt-1 float-left">
                                                <h3 class="mb-0 fw-r">
                                                    <span class="count">{{ $tercero->get_total_peso_facturas() }}</span>
                                                    Kg
                                                </h3>
                                                <p class="text-light mt-1 m-0">Total Comprado</p>
                                            </div>
                                                    ...
                                                    <div class="card text-white bg-flat-color-2">
                                                        <div class="card-body">
                                                            <div class="card-left pt-1 float-left">
                                                                ...
                                                                <p class="text-light mt-1 m-0">Total productos</p>
                                                            </div><!-- /.card-left -->
